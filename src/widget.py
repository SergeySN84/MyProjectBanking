...
def mask_account_card (account_card: str) -> str:
    ...
    elif "MasterCard" in account_card_list or "Maestro" in account_card_list:
        return f"{account_card_list[0]} {get_mask_card_number(account_card_list[1])}"
    elif "Visa" in account_card_list:
        number_for_mask = []
        name_for_mask = []
