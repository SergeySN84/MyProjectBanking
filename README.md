...
из файлов в формате csv и xlsx.
 - Добавлены модули filters и main, в них реализованны основные функции для работы
с банковскими транзакциями размещенные в файлах разных форматов расположенных в
папке data.
## Тестирование
 ...
 - Добавлены тесты для модулей filters и main.
## Документация:
